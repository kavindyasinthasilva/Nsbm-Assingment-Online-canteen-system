...
namespace Bill.Checkout
{
    class chackcart
    {
        ...
        public void total(object reslt)
        {
        ...
        public void other(string x, string y, string z,string t,string a,string b)
        {
            ...
            string commandString = "INSERT INTO oder(name,address,phone,cradit,css,desk) VALUES('" + name.ToString() + "','" + add.ToString() + "','" + phone.ToString() + "','" + cratid.ToString() + "','" + css.ToString() + "','" + t.ToString() + "');";
